...
<html lang="en">
	...
	<body>
		...
		<main>
			...
			<h2>Persona</h2>
			<ul><strong>Name:</strong> Morrissey, Steve</ul>
			<ul><strong>Age:</strong> 27 years-old</ul>
				<ul><strong>Occupation:</strong> Works in Bloomingdale's men's fashionable department in Palo Alto, Calif.</ul>
				<ul><strong>Technology:</strong> Uses Iphone 7.</ul>
				<ul><strong>Needs:</strong> Steve biggest hobby is competing in single-day and time-trial bicycle races. So he needs to keep track of distance and routes he rides. And, he is also appearance and health conscious, so working in in Palo Alto, he is able to to ride his bicycle to and from work.</ul>
				<ul><strong>Goals:</strong> He lives in a large cyclists community, so he wants to see other routes where other cyclists have rode on or discovered.</ul>
